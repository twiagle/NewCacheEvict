...
//    public static long trainTime = 0;
//    public static long testTime = 0;
    public ClassOption baseLearnerOption = new ClassOption("baseLearner", 'l',
            "Classifier to train.", Classifier.class, "bayes.NaiveBayes");

    public IntOption periodOption = new IntOption("period", 'p',
            "Size of the environments.", Config.getInstance().getTrainingInterval(), 1, Integer.MAX_VALUE);
    ...
    public IntOption ensembleSizeOption = new IntOption("ensembleSize", 'e',
            "Ensemble size.", 5, 1, Integer.MAX_VALUE);
    ...
    public MultiChoiceOption pruningStrategyOption = new MultiChoiceOption(
            ...
            new String[]{"NO", "AGE", "ERROR"}, new String[]{
                "Don't prune classifiers", "Age-based", "Error-based"}, 2);
    ...
    public void resetLearningImpl() {
        ...
        this.trainingWeightSeenByModel = 1.0;
    }
...
//            this.buffer = new Instances(this.getModelContext());
            this.buffer = new Instances(Config.getInstance().getInstancesHeader());
        }
    }
